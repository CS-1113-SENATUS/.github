...
CAs: start here. Everything below lives in the [**Course-Material**](https://github.com/CS-1113-SENATUS/Course-Material) repo unless noted otherwise.

| Need | Go to |
|---|---|
| Syllabus | [Fall 2026 Syllabus](https://github.com/CS-1113-SENATUS/Course-Material#1) |
| Homework | [Homework](https://github.com/CS-1113-SENATUS/Course-Material#2) |
| Lab exercises | [Exercises](https://github.com/CS-1113-SENATUS/Course-Material#3-1) |
| Lab quizzes | [Quizzes](https://github.com/CS-1113-SENATUS/Course-Material#3-2) |
| Practice problems | [Problem Bank](https://github.com/CS-1113-SENATUS/Course-Material#4) |
...
Recordings, materiel, and minutes for CA training sessions and weekly senate meetings. Full minutes archive: [`profile/assets/meeting-minutes/notes`](https://github.com/CS-1113-SENATUS/.github/tree/main/profile/assets/meeting-minutes/notes).
...
- Course Assistants (CAs):
  ...
  - **Lab 5**: Leonardo Villalobos, Matthew Jiang, Natt Hong
